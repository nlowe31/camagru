<div class="box login">
    ...
    <div class="box_content">
        ...
        <form method="POST" action="/user/createUser">
            <p><input type="text" class="text_box" placeholder="Username" name="username" required/></p>
            <p><input type="email" class="text_box" placeholder="Email" name="email" title="Must be a valid email address" required/></p>
            <p><input type="text" class="text_box" placeholder="First Name" name="firstName" required/></p>
            <p><input type="text" class="text_box" placeholder="Last Name" name="lastName" required/></p>
